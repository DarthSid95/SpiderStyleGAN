...
def subprocess_fn(rank, args, temp_dir):
    ...
    G_Full = copy.deepcopy(args.G_Full).eval().requires_grad_(False).to(device)
    ...
    for metric in args.metrics:
        ...
        result_dict = metric_main.calc_metric(metric=metric, G=G_Full, dataset_kwargs=args.dataset_kwargs,
...
def calc_metrics(ctx, network_pkl, metrics, data, mirror, gpus, verbose):
    ...
    with dnnlib.util.open_url(network_pkl, verbose=args.verbose) as f:
        ...
        args.G_Full = network_dict['G_full'] # Used to be G_ema # subclass of torch.nn.Module
        args.G = network_dict['G_ema'] # Used to be G_ema # subclass of torch.nn.Module
